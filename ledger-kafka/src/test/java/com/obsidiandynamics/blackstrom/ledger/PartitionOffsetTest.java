...
public final class PartitionOffsetTest {
  ...
  public void testSummarise() {
    final var map = Map.of(new TopicPartition("testTopic", 2), new OffsetAndMetadata(200),
                           new TopicPartition("testTopic", 3), new OffsetAndMetadata(300),
                           new TopicPartition("testTopic", 1), new OffsetAndMetadata(100));
